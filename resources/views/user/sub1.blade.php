...
<body id="page_sub1"><input type="hidden" id="input_page" value="">
    <main>
        <h3>입주민 동의서</h3>
        <form id="form" class="bx_form">
            ...
            <div class="wrap_input wrap_date">
                <div class="for_datepicker"><input type="text" name="start_date" id="start_date" class="input_dateFrom datepicker" max="9999-12-31" placeholder="시작일을 선택해 주세요."></div>
                부터
                <div class="for_datepicker"><input type="text" name="end_date" id="end_date" class="input_dateTo datepicker" max="9999-12-31" placeholder="종료일을 선택해 주세요."></div>
            </div>
            ...
            <div class="wrap_input">
                ...
                <input type="text" id="address1" name="address2" placeholder="000동 0000호">
            </div>
            ...
            <div class="wrap_input">
                <label class="lb_chk">
                    <input type="checkbox" name="option1" id="" onclick="disabledCompanyName(this)">
                    셀프 직영 공사입니다
                </label>
            ...
            <div class="wrap_input">
                <label class="lb_chk">
                    <input type="checkbox" name="" id="" onclick="getUser(1,this)">
                    위 신청인과 같아요.
                </label>
                <input type="text" name="manager_name" id="" class="input_name" placeholder="성명">
                <input type="text" name="manager_phone" id="" maxlength="13" oninput="phoneValidation(this)" placeholder="-없이 숫자만 입력해주세요">
            </div>

            <h4>입주자의 성명과 연락처를 작성해주세요.</h4>
            <h5>공사신고시 필요한 기본정보이며 실제 입주자와 달라도 무관합니다.</h5>
            <div class="wrap_input">
                <label class="lb_chk"><input type="checkbox" name="option2" id="" onclick="getUser(2,this)">위 신청인과 같아요.</label>
