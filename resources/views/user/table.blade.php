    ...
    <main>
        ...
        <table class="tb_main">
            ...
            <tbody>
                ...
                <tr>
                    <td rowspan="7">전국</td>
                    <td rowspan="7">폐기물 수거</td>
                    <td>소량(10마대 이하)</td>
                    <td colspan="2">70,000원 ~ 90,000원</td>
                </tr>
                <tr>
                    <td>6분의 1차 이하</td>
                    <td colspan="2">100,000원 ~ 120,000원</td>
                </tr>
                <tr>
                    <td>3분의 1차 이하</td>
                    <td colspan="2">180,000원 ~ 210,000원</td>
                </tr>
                <tr>
                    <td>2분의 1차 이하</td>
                    <td colspan="2">280,000원 ~ 310,000원</td>
                </tr>
                <tr>
                    <td>3분의 2차 이하</td>
                    <td colspan="2">370,000원 ~ 390,000원</td>
                </tr>
                <tr>
                    <td>1차 이하</td>
                    <td colspan="2">460,000원 ~ 490,000원</td>
                </tr>
                <tr>
                    <td>현장 정리 + 하역(1시간)</td>
        ...
        <table class="tb_main">
            ...
            <thead>
                ...
                <tr style="height:36px;">
                    ...
                    <th>중</br>1000 X 1700(mm)</td>
                    <th>소</br>700 X 700(mm)</td>
                </tr>
                <tr style="height:36px;">
                    <th>거실</br>(전창)</td>
                    <th>방</br>(반창)</td>
