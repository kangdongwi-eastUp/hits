    ...
    <main>
        ...
        <form id="form" class="bx_form">
            ...
            <div class="wrap_input">
                ...
                <input type="text" id="company_phone" name="company_phone" maxlength="13" oninput="phoneValidation(this)" placeholder="연락처는 숫자만 입력해주세요">
            </div>
            ...
            <div class="bx_chks">
                ...
                <label class="lb_chk"><input type="checkbox" name="boyang[]" value="알 수 없으며 알아서 싣고 연락 주세요." id="">알 수 없으며 알아서 싣고 연락 주세요.</label>
                <label class="lb_chk"><input type="checkbox" name="boyang[]" value="알 수 없으며 싣기전 연락 주세요." id="">알 수 없으며 싣기전 연락 주세요.</label>
            </div>
