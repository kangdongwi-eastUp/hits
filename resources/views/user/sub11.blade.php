...
<body id="page_sub11"><input type="hidden" id="input_page" value="">
    <main>
        ...
        <form id="form" class="bx_form">
            <h4>청소 희망일을 선택해 주세요 <span class="t_red">*</span></h4>
            ...
            <h4>청소 공간의 유형을 선택해 주세요.<span class="t_red">*</span></h4>
            <h5>중복 선택이 가능합니다.</h5>
            <div class="bx_chks">
                <label class="lb_chk"><input type="checkbox" name="boyang[]" value="주거 공간" id="">주거 공간</label>
                <label class="lb_chk"><input type="checkbox" name="boyang[]" value="사무 공간" id="">사무 공간</label>
                <label class="lb_chk"><input type="checkbox" name="boyang[]" value="상업 공간" id="">상업 공간</label>
